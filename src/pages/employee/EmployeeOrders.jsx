...
const EmployeeOrders = () => {
  ...
  const getAmount = (order) => {
    return order.totalAmount ?? order.amount ?? order.grandTotal ?? 0;
  };
  ...
  const totalRevenue = orders.reduce(
    (total, order) => total + Number(getAmount(order) || 0),
    0
  );
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
            <div>
              ...
              <p className="text-slate-300 mt-3">
                Track kitchen workflow, update order preparation and monitor live food processing.
              </p>
            </div>
