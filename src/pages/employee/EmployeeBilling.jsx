...
const EmployeeBilling = () => {
  ...
  const getOrderCode = (bill) => {
    return (
      bill.order?.orderCode ||
      bill.foodOrder?.orderCode ||
      bill.orderId ||
      "N/A"
    );
  };
  ...
  const totalAmount = bills.reduce(
    (sum, bill) => sum + Number(getAmount(bill) || 0),
    0
  );
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-black p-4 md:p-8">
      <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
            <div>
              ...
              <p className="text-slate-300 mt-3">
                View restaurant billing records, order references and total
                billing value.
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <div className="bg-white rounded-3xl p-5 shadow-2xl">
            <p className="text-slate-500 font-semibold">Billing Value</p>
                ...
                {bills.length === 0 ? (
                  ...
                  bills.map((bill) => (
                    ...
                    >
                      ...
                      <td className="p-4 font-bold">₹ {getAmount(bill)}</td>

                      <td className="p-4">{getCreatedAt(bill)}</td>
            ...
            <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl p-6 relative">
              ...
              <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-slate-100 p-4 rounded-2xl">
                  ...
                  <p className="font-bold">₹ {getAmount(selectedBill)}</p>
                </div>

                <div className="bg-slate-100 p-4 rounded-2xl">
                  <p className="text-slate-500 text-sm">Created</p>
                  <p className="font-bold">{getCreatedAt(selectedBill)}</p>
                </div>
